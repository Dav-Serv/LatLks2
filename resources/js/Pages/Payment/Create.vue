    ...
    <AppLayout :title="title">
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <ButtonLink :href="route('payments.index')">Back</ButtonLink>
                <form @submit.prevent="createPayment" class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6 mt-4">
                    <div class="mb-7">
                        <div class="mb-4">
                            <label class="block font-medium text-sm text-gray-700">Name Payment</label>
                            <input
                                id="name"
                                v-model="form.name"
                                type="text"
